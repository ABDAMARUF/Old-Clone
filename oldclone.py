...
# --- Global Definitions and Colors ---
G = '\x1b[1;92m' # Green
W = '\x1b[0;97m' # White
Y = '\x1b[1;93m' # Yellow
B = '\x1b[1;90m' # Black/Grey
RED = '\x1b[1;91m' # Red (Added for error messages)
...
REAL_USERNAME = 'claymistcybervail'
REAL_PASSWORD = 'RAOHAD'

def line():
    print(f"{W}───────────────────────────────────────────────")

# --- New Authentication Gate Function ---
def authentication_gate():
    os.system('clear')
    while True:
        line()
        print(f"{W}       {RED}### USER AUTHENTICATION REQUIRED ###{W}")
        line()
        
        entered_user = input(f"{W} {ch} {W}ENTER USERNAME {G}:{W} ")
        
        if entered_user != REAL_USERNAME:
            os.system('clear')
            print(f"{RED} WRONG USER FUCK YOU{W}")
            time.sleep(2)
            os.system('clear')
            continue 

        entered_pass = input(f"{W} {ch} {W}ENTER PASSWORD {G}:{W} ")
        
        if entered_pass == REAL_PASSWORD:
            print(f"{G} AUTHENTICATION SUCCESSFUL.{W}")
            time.sleep(1)
            os.system('clear')
            break
        else:
            os.system('clear')
            print(f"{RED} WRONG PASSWORD FUCK YOU{W}")
            time.sleep(2)
            os.system('clear')
...
| $$    $$| $$ /$$__  $$| $$  | $$| $$\  $ | $$| $$ \____  $$  | $$ /$$      
|  $$$$$$/| $$|  $$$$$$$|  $$$$$$$| $$ \/  | $$| $$ /$$$$$$$/  |  $$$$/      
 \______/ |__/ \_______/ \____  $$|__/     |__/|__/|_______/    \___/        
                         /$$  | $$                                           
                        |  $$$$$$/                                           
                         \______/
\x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mDEVELOPER \x1b[1;91m : \x1b[1;92mEDWIN THAMSA
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mFACEBOOK \x1b[1;91m : \x1b[1;92mCLAYMIST CYBER VAIL 
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mOnly For \x1b[1;91m : \x1b[1;92mTEAM MEMBERS
\x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mVERSION \x1b[1;91m : \x1b[1;92m47.5
\x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
if __name__ == '__main__':
    # Authentication check runs before main program
    authentication_gate()
    main()